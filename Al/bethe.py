...
# Aluminum properties
Z_AL = 13  # atomic number
A_AL = 26.9815  # atomic mass (g/mol)

# User inputs - EDIT THESE VALUES
DENSITY_AL = 2.699  # g/cm^3 - material density
...
def main():
    ...
    print(f"Material: Aluminum (Z={Z_AL}, A={A_AL} g/mol)")
    print()
    ...
    for i in range(1, len(thickness_um)):
        ...
        I_nominal = find_mean_excitation_energy_for_thickness(E1, E2, th_cm, Z_AL, A_AL, rho)
        
        print(f"  Nominal I = {I_nominal:.2f} eV")
        
        # Propagate uncertainties
        unc_dict = propagate_uncertainty(E1, E2, th_cm, E1_unc, E2_unc, th_unc_cm, rho, rho_unc, Z_AL, A_AL, I_nominal)
    ...
    # Save results
    out_path = os.path.join(base_dir, 'ionization_results.txt')
    with open(out_path, 'w', encoding='utf-8') as f:
        f.write('# Mean Excitation Energy Analysis Results\n')
        f.write(f'# Material: Aluminum (Z={Z_AL}, A={A_AL} g/mol)\n')
