...
PEAK_CHANNELS_NIT3 = {
    'T0_0156nit3.txt': {'pu': 877, 'am': 934, 'cm': 990},
    'T40_1nit3.txt': {'pu': 812, 'am': 871, 'cm': 928},
    'T60_3nit3.txt': {'pu': 769, 'am': 832, 'cm': None},
    'T80_1nit3.txt': {'pu': 732, 'am': 799, 'cm': 859},
    'T99_8nit3.txt': {'pu': 690, 'am': 757, 'cm': 818},
    'T121nit3.txt': {'pu': 651, 'am': 718, 'cm': None},
    'T144nit3.txt': {'pu': 593, 'am': 667, 'cm': None},
    'T159nit3.txt': {'pu': 566, 'am': 640, 'cm': None},
    'T206nit3.txt': {'pu': 445, 'am': 531, 'cm': 609},
    'T251nit3.txt': {'pu': 300, 'am': 405, 'cm': None},
    'T303nit3.txt': {'pu': 81, 'am': 233, 'cm': 349},
}

# Optional: specify fit gaps per source (if not specified, GAP_DISTANCE=8 is used)
PEAK_GAPS_NIT3 = {
    'T0_0156nit3.txt': {'pu': 8, 'am': 8, 'cm': 8},
    'T40_1nit3.txt': {'pu': 8, 'am': 8, 'cm': 5},
    'T60_3nit3.txt': {'pu': 8, 'am': 8, 'cm': None},
    'T80_1nit3.txt': {'pu': 8, 'am': 8, 'cm': 8},
    'T99_8nit3.txt': {'pu': 10, 'am': 8, 'cm': 8},
    'T121nit3.txt': {'pu': 8, 'am': 8, 'cm': None},
    'T144nit3.txt': {'pu': 8, 'am': 8, 'cm': None},
    'T159nit3.txt': {'pu': 8, 'am': 8, 'cm': None},
    'T206nit3.txt': {'pu': 8, 'am': 8, 'cm': 10},
    'T251nit3.txt': {'pu': 14, 'am': 18, 'cm': None},
    'T303nit3.txt': {'pu': 19, 'am': 17, 'cm': 13},
}

# Per-file peak channels for Nit4 (single peak per file)
PEAK_CHANNELS_NIT4 = {
	'T0_00353nit4.txt': {'th': 1497},
	'T11_1nit4.txt': {'th': 1443},
	'T22_3nit4.txt': {'th': 1392},
	'T33_3nit4.txt': {'th': 1342},
	'T44nit4.txt': {'th': 1287},
	'T54_9nit4.txt': {'th': 1243},
	'T65_2nit4.txt': {'th': 1181},
	'T76_9nit4.txt': {'th': 1124},
	'T88nit4.txt': {'th': 1065},
	'T98_7nit4.txt': {'th': 1002},
	'T111nit4.txt': {'th': 924},
	'T122nit4.txt': {'th': 846},
	'T136nit4.txt': {'th': 756},
	'T146nit4.txt': {'th': 685},
...
# Optional per-file fit gaps for Nit4 (single peak per file)
PEAK_GAPS_NIT4 = {
	'T0_00353nit4.txt': {'th': 10},
	'T11_1nit4.txt': {'th': 10},
	'T22_3nit4.txt': {'th': 18},
	'T33_3nit4.txt': {'th': 12},
	'T44nit4.txt': {'th': 16},
...
def main():
	...
	calib_nit3 = load_calibration_params(os.path.join(base_dir, 'calibration_params_nit3.txt'))
	if calib_nit3:
		print(f"Loaded NIT3 calibration: a={calib_nit3.get('a', 'N/A')}, c={calib_nit3.get('c', 'N/A')}")
	else:
		print('Note: calibration_params_nit3.txt not found. NIT3 energy calibration will not be applied.')

	calib_nit4 = load_calibration_params(os.path.join(base_dir, 'calibration_params_nit4.txt'))
	if calib_nit4:
		print(f"Loaded NIT4 calibration: a={calib_nit4.get('a', 'N/A')}, c={calib_nit4.get('c', 'N/A')}")
	else:
		print('Note: calibration_params_nit4.txt not found. NIT4 energy calibration will not be applied.')
