...
# --- User configuration (Ar stations) ---
...
PEAK_CHANNELS_AR3 = {
    'T0_0156ar3.txt': {'pu': 877, 'am': 934, 'cm': 990},
    'T30_3ar3.txt': {'pu': 815, 'am': 872, 'cm': 928},
    'T60_7ar3.txt': {'pu': 750, 'am': 811, 'cm': 869},
    'T90_8ar3.txt': {'pu': 713, 'am': 776, 'cm': 838},
    'T109ar3.txt': {'pu': 678, 'am': 744, 'cm': 807},
    'T120ar3.txt': {'pu': 655, 'am': 723, 'cm': 788},
    'T135ar3.txt': {'pu': 624, 'am': 690, 'cm': 757},
    'T154_5ar3.txt': {'pu': 580, 'am': 653, 'cm': None},
    'T167ar3.txt': {'pu': 553, 'am': 624, 'cm': None},
    'T179ar3.txt': {'pu': 527, 'am': 603, 'cm': 674},
    'T209ar3.txt': {'pu': 452, 'am': 535, 'cm': 612},
    'T223ar3.txt': {'pu': 414, 'am': 505, 'cm': 579},
    'T239ar3.txt': {'pu': 375, 'am': 464, 'cm': 545},
    'T270ar3.txt': {'pu': 278, 'am': 383, 'cm': 468},
    'T287ar3.txt': {'pu': 226, 'am': 334, 'cm': 430},
    'T297ar3.txt': {'pu': 188, 'am': 305, 'cm': None},
    'T328ar3.txt': {'pu': 55, 'am': 204, 'cm': 311},
    'T360_5ar3.txt': {'pu': None, 'am': 52, 'cm': None},
}

# Optional: specify fit gaps per source (if not specified, GAP_DISTANCE=8 is used)
PEAK_GAPS_AR3 = {
    'T0_0156ar3.txt': {'pu': 4, 'am': 4, 'cm': 1},
    'T30_3ar3.txt': {'pu': 6, 'am': 6, 'cm': 4},
    'T60_7ar3.txt': {'pu': 5, 'am': 9, 'cm': 9},
    'T90_8ar3.txt': {'pu': 8, 'am': 5, 'cm': 5},
    'T109ar3.txt': {'pu': 7, 'am': 6, 'cm': 3},
    'T120ar3.txt': {'pu': 7, 'am': 6, 'cm': 5},
    'T135ar3.txt': {'pu': 6, 'am': 8, 'cm': 7},
    'T154_5ar3.txt': {'pu': 8, 'am': 8, 'cm': None},
    'T167ar3.txt': {'pu': 6, 'am': 6, 'cm': None},
    'T179ar3.txt': {'pu': 8, 'am': 11, 'cm': 10},
    'T209ar3.txt': {'pu': 6, 'am': 7, 'cm': 8},
    'T223ar3.txt': {'pu': 11, 'am': 6, 'cm': 16},
    'T239ar3.txt': {'pu': 13, 'am': 10, 'cm': 11},
    'T270ar3.txt': {'pu': 6, 'am': 6, 'cm': 12},
    'T287ar3.txt': {'pu': 7, 'am': 15, 'cm': 11},
    'T297ar3.txt': {'pu': 25, 'am': 15, 'cm': None},
    'T328ar3.txt': {'pu': 6, 'am': 15, 'cm': 11},
    'T360_5ar3.txt': {'pu': None, 'am': 15, 'cm': None},
}

# Per-file peak channels for Ar4 (single peak per file)
PEAK_CHANNELS_AR4 = {
	'T0_00353ar4.txt': {'th': 1496},
	'T14_2ar4.txt': {'th': 1431},
	'T31_1ar4.txt': {'th': 1348},
	'T47_5ar4.txt': {'th': 1277},
	'T60_4ar4.txt': {'th': 1211},
	'T71_9ar4.txt': {'th': 1158},
	'T84_6ar4.txt': {'th': 1095},
	'T96_8ar4.txt': {'th': 1030},
	'T110ar4.txt': {'th': 950},
	'T122ar4.txt': {'th': None},
	'T134ar4.txt': {'th': None},
	'T144ar4.txt': {'th': 737},
...
# Optional per-file fit gaps for Ar4 (single peak per file)
PEAK_GAPS_AR4 = {
	'T0_00353ar4.txt': {'th': 8},
	'T14_2ar4.txt': {'th': 10},
	'T31_1ar4.txt': {'th': 18},
	'T47_5ar4.txt': {'th': 17},
	'T60_4ar4.txt': {'th': 27},
...
def process_station(base_dir, station_tag, sources, peak_channels, peak_gaps, calib_params):
	...
	for pressure_mbar, fn in sorted(station_files):
		...
		plt.xlabel('Channel')
		plt.ylabel('Counts')
		plt.title(f'{station_tag.upper()} - Thickness = {thickness_val:.3f} {thickness_unit}')
		plt.tight_layout()
		if SHOW_PLOTS:
			plt.show()
		plt.close()
		...
		for source in sources:
			...
			if curve_fit is None:
				...
				if all_vals is None or len(all_vals) == 0:
					...
					plt.ylabel('Count')
					plt.title(f'{station_tag.upper()} {source.upper()} - Peak distribution')
					...
					if len(best_fits_info) > 0:
						...
						for idx in range(len(top_4), 4):
							axes[idx].axis('off')
						fig.suptitle(f'{station_tag.upper()} {source.upper()} - Top 4 Best Fits', fontsize=14, fontweight='bold')
						plt.tight_layout()
						if SHOW_PLOTS:
							plt.show()
						plt.close(fig)
	...
	if out_lines:
		...
		plt.title(f'{station_tag.upper()} - Peak channel vs thickness')
		plt.grid(True)
		plt.legend()
		plt.tight_layout()
		if SHOW_PLOTS:
		...
		if calib_params:
			...
			plt.title(f'{station_tag.upper()} - Energy vs thickness')
			plt.grid(True)
			plt.legend()
			plt.tight_layout()
			if SHOW_PLOTS:
...
def main():
	...
	calib_ar3 = load_calibration_params(os.path.join(base_dir, 'calibration_params_ar3.txt'))
	if calib_ar3:
		print(f"Loaded AR3 calibration: a={calib_ar3.get('a', 'N/A')}, c={calib_ar3.get('c', 'N/A')}")
	else:
		print('Note: calibration_params_ar3.txt not found. AR3 energy calibration will not be applied.')

	calib_ar4 = load_calibration_params(os.path.join(base_dir, 'calibration_params_ar4.txt'))
	if calib_ar4:
		print(f"Loaded AR4 calibration: a={calib_ar4.get('a', 'N/A')}, c={calib_ar4.get('c', 'N/A')}")
	else:
		print('Note: calibration_params_ar4.txt not found. AR4 energy calibration will not be applied.')
